...
export const Commerce = createDimension({
    ...
    unix_ts: createAttribute({
        name: 'unix_ts',
        type: 'numeric-attribute',
        expression: '[Commerce.unix_ts]',
        dataSource: { title: 'Sample ECommerce', live: false },
    }),
...
export const Country = createDimension({
    ...
    Country_HTML: createAttribute({
        name: 'Country_HTML',
        type: 'text-attribute',
        expression: '[Country.Country_HTML]',
        dataSource: { title: 'Sample ECommerce', live: false },
    }),
    Flag: createAttribute({
        name: 'Flag',
        type: 'text-attribute',
        expression: '[Country.Flag]',
        dataSource: { title: 'Sample ECommerce', live: false },
    }),
}) as CountryDimension;
